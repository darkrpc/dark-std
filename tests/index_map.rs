...
#[test]
pub fn test_debug() {
    let m: SyncIndexMap<i32, i32> = SyncIndexMap::new();
    m.insert(1, 1);
    println!("{:?}", m);
...
#[test]
pub fn test_insert2() {
    let m = Arc::new(SyncIndexMap::<String, String>::new());
...
// #[test]
// pub fn test_insert3() {
//     let m = Arc::new(SyncIndexMap::<i32, i32>::new());
...
#[test]
pub fn test_remove2() {
    let m = SyncIndexMap::<i32, String>::new();
    for i in 0..1000000 {
...
//     let m1 = Arc::new(SyncIndexMap::<i32, i32>::new());
//     for i in 0..10000 {
//         let wg = wait1.clone();
//         let m = m1.clone();
//
